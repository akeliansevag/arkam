...
const IconsTextBlock = ({title,items,backgroundClass}) => {
  return (
    <div className={`${backgroundClass ? backgroundClass : ''} rounded-2xl p-10`}>
            ...
            items && items.map((item,index)=>{
              return (
                <div key={index} className='flex items-center gap-3'>
                  <div className='w-[70px] h-[70px] rounded-2xl bg-gradient-140 flex items-center justify-center'>
