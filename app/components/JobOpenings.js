  ...
  return (
    <section>
        <div className='container'>
            <h2 className="text-center section-title">Join Our Team</h2>
            <p className="max-w-[800px] mx-auto text-center">We are currently hiring for the following positions</p>
            <div className='flex gap-5 max-lg:flex-col mt-10'>
                {
                    openings && openings.map((job,key)=>
                        (
                            <div key={key} className="bg-gradient-light rounded-2xl p-8 w-full text-center">
