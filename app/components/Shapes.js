...
const Shapes = () => {
  return (
    <motion.div {...fadeInUpOnMount(0.4)} className='relative max-w-[950px] mx-auto w-full lg:mt-24 max-lg:mt-10'>
        ...
        <div className='absolute w-full z-0 top-20 lg:top-50'>
            <Tilt gyroscope={true} transitionSpeed={4000} perspective={1300} reset={false} trackOnWindow={true} tiltReverse={true}>
